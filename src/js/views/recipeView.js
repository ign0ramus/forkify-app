...
export const updateServingsIngredients = recipe => {
    ...
    const countElems = Array.from(document.querySelectorAll('.recipe__count'));
    countElems.forEach((elem, idx) => {
        elem.textContent = formatCount(recipe.ingredients[idx].count);
    });
};